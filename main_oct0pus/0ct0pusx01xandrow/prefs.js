...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1667602830);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{b31b89f3-047c-4f36-bf87-fb586f31c7ca}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1667602819979");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1667624419979");
...
user_pref("browser.slowStartup.averageTime", 14279);
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"58edf665-8ee2-457d-a858-d9fac6e5ba9a\"}");
...
user_pref("marionette.port", 12019);
user_pref("media.gmp-manager.buildID", "20180128191252");
user_pref("media.gmp-manager.lastCheck", 1667602836);
...
user_pref("toolkit.startup.last_success", 1667602795);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "f757ac50-1061-4884-9643-5b934c2d9464");
