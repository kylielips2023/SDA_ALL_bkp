...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1667784503);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1667775600);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1667784487839");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1667806087839");
...
user_pref("browser.slowStartup.averageTime", 10840);
...
user_pref("e10s.rollout.cohortSample", "0.451428");
user_pref("e10s.rollout.cohortSample.multi", "0.129224");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"d45cbd0c-548a-4601-afe1-e8da8d601c61\"}");
...
user_pref("marionette.port", 11389);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1667784499);
...
user_pref("toolkit.startup.last_success", 1667784469);
