...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1668194911);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1668194895115");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1668216495115");
...
user_pref("browser.slowStartup.averageTime", 11468);
...
user_pref("e10s.rollout.cohortSample", "0.926090");
user_pref("e10s.rollout.cohortSample.multi", "0.062061");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"0c85c221-6ec8-4274-91e2-d98927d58a48\"}");
...
user_pref("marionette.port", 24633);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1668194907);
...
user_pref("toolkit.startup.last_success", 1668194876);
