...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1675097606);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{eb8e3a24-54a0-4109-aab4-bee07160ee65}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1675097586281");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1675119186281");
...
user_pref("browser.slowStartup.averageTime", 4864);
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"6608dee2-2406-425f-8326-da6de8e24ac0\"}");
...
user_pref("marionette.port", 12269);
user_pref("media.gmp-manager.buildID", "20180128191252");
user_pref("media.gmp-manager.lastCheck", 1675097599);
...
user_pref("toolkit.startup.last_success", 1675097573);
