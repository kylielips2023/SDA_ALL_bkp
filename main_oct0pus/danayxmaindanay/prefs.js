...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1672025960);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1671948000);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1672025945750");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1672047545750");
...
user_pref("browser.slowStartup.averageTime", 12902);
...
user_pref("e10s.rollout.cohortSample", "0.718834");
user_pref("e10s.rollout.cohortSample.multi", "0.910588");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"524c1ea7-5379-4944-b955-164e465b8910\"}");
...
user_pref("marionette.port", 37475);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1672025956);
...
user_pref("places.history.expiration.transient_current_max_pages", 96137);
...
user_pref("toolkit.startup.last_success", 1672025924);
