...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1673989146);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{4017ed23-e73d-4352-b4d6-612c7cff1c2f}");
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1673910000);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1673989131810");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1674010731810");
...
user_pref("browser.slowStartup.averageTime", 14496);
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"f379a144-431c-4dfa-aa60-3087d38f0a89\"}");
...
user_pref("marionette.port", 14899);
user_pref("media.gmp-manager.buildID", "20180128191252");
user_pref("media.gmp-manager.lastCheck", 1673989144);
...
user_pref("places.history.expiration.transient_current_max_pages", 21215);
...
user_pref("toolkit.startup.last_success", 1673989109);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "3d23110e-0f51-440b-9e1b-91b01b65dd41");
