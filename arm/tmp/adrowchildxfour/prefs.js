...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1673264009);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1673218800);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1673264019563");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1673285619563");
...
user_pref("browser.slowStartup.averageTime", 13388);
...
user_pref("e10s.rollout.cohortSample", "0.779811");
user_pref("e10s.rollout.cohortSample.multi", "0.616905");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"10b66c9a-287e-4ea2-ba54-ec496056ecfc\"}");
...
user_pref("marionette.port", 32669);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1673264007);
...
user_pref("places.history.expiration.transient_current_max_pages", 75465);
...
user_pref("toolkit.startup.last_success", 1673263974);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "bad1ad69-0319-4b24-a503-943477a9a455");
