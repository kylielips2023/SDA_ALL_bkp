...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1667785031);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{f642280b-bf00-4c23-ba69-ac7b357bf1b5}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1667785009562");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1667806609562");
...
user_pref("browser.slowStartup.averageTime", 3977);
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"7d454bfd-1965-4cc9-b254-79cefa4957fa\"}");
...
user_pref("marionette.port", 17637);
user_pref("media.gmp-manager.buildID", "20180128191252");
user_pref("media.gmp-manager.lastCheck", 1667785023);
...
user_pref("toolkit.startup.last_success", 1667784999);
