...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1672026289);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1672026270279");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1672047870279");
...
user_pref("e10s.rollout.cohortSample", "0.749476");
user_pref("e10s.rollout.cohortSample.multi", "0.155560");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"bce77421-5417-41b3-80db-20ffce32ef08\"}");
...
user_pref("marionette.port", 17673);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1672026283);
...
user_pref("places.history.expiration.transient_current_max_pages", 95847);
...
user_pref("toolkit.startup.last_success", 1672026257);
