...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1667627879);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{3aa55ce3-253f-419f-b14c-acf5ebbecfc9}");
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1667627868184");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1667649468184");
...
user_pref("browser.slowStartup.averageTime", 12300);
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"558f35eb-8563-48fb-8eb2-3ed349bfb4fe\"}");
...
user_pref("marionette.port", 12951);
user_pref("media.gmp-manager.buildID", "20180128191252");
user_pref("media.gmp-manager.lastCheck", 1667627877);
...
user_pref("toolkit.startup.last_success", 1667627844);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "381eb281-d26e-4ce1-a092-39acd549632f");
