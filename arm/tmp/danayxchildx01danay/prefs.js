...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1672038625);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1672009200);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1672038617748");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1672060217748");
...
user_pref("browser.slowStartup.averageTime", 20639);
...
user_pref("e10s.rollout.cohortSample", "0.805456");
user_pref("e10s.rollout.cohortSample.multi", "0.684168");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"a78a4031-4119-42fa-8e89-2cc3b07e9944\"}");
...
user_pref("marionette.port", 19631);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1672038625);
...
user_pref("places.history.expiration.transient_current_max_pages", 94201);
...
user_pref("toolkit.startup.last_success", 1672038585);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "5b66e578-0b89-44d7-8df2-19927116e979");
