...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1673374199);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1673308800);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1673374180270");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1673395780270");
...
user_pref("browser.slowStartup.averageTime", 4048);
...
user_pref("e10s.rollout.cohortSample", "0.369270");
user_pref("e10s.rollout.cohortSample.multi", "0.074212");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"80a6c7cb-c134-43f4-b6c5-cdd44436cfe3\"}");
...
user_pref("media.gmp-manager.lastCheck", 1673374201);
...
user_pref("places.history.expiration.transient_current_max_pages", 66386);
...
user_pref("toolkit.startup.last_success", 1673374167);
