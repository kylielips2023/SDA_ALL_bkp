...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1671582606);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1671582589188");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1671604189188");
...
user_pref("browser.slowStartup.averageTime", 9535);
...
user_pref("e10s.rollout.cohortSample", "0.368361");
user_pref("e10s.rollout.cohortSample.multi", "0.397040");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"f4f0ea1d-fdd2-42e1-9c5d-d350a712c45f\"}");
...
user_pref("marionette.port", 23347);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1671582602);
...
user_pref("toolkit.startup.last_success", 1671582572);
