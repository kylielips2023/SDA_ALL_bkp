...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1671505310);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1671429600);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1671505293546");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1671526893546");
...
user_pref("browser.slowStartup.averageTime", 10725);
...
user_pref("e10s.rollout.cohortSample", "0.823513");
user_pref("e10s.rollout.cohortSample.multi", "0.730996");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"10334b9f-4ae9-4981-8f22-8498600dfbfc\"}");
...
user_pref("marionette.port", 31887);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1671505306);
...
user_pref("toolkit.startup.last_success", 1671505276);
