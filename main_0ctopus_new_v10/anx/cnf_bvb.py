...
from anx import allfig

print("INIT config ..... ", end='')
hostname_os=allfig.hostname_os
goog=allfig.goog
...
def extact_gc_profile():
	print("Extact")
	remove_old_folder="rm -r anx/"+g00g_acc
	os.system(remove_old_folder)
	comom="cp po/"+g00g_acc+".tar.gz anx/"
	os.system(comom)
	name_archive_account="anx/"+g00g_acc+'.tar.gz'
