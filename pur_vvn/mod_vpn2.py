...
if "V" in vpn_type:
	...
	typ0="V"
if "P" in vpn_type:
	file_list_1='PURE_list_1'
	vpn_folder=pwd+"/conf_p/"
	typ0="P"
...
def get_random_vpn():
	...
	# fresh_config,int_used=vpn_sql.get_fresh_config(typ0)
	# print(fresh_config,int_used)
	data_id,data_cnf_names,data_used,van_config_left = api_mysql.get_random_api_pure()
...
def fnc_vpn():
	...
	with open ('/var/log/openvpn/openvpn.log', "r") as logfile:
		...
		if logfile.read().find('Sequence Completed') !=-1:
			...
			api_mysql.update_conf_pure_api(id_config)
			# print(meddas)
