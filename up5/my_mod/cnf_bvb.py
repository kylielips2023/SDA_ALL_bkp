...
vpn_type="N"
total_l0g=[]
vversion="SITE_5 V 6.0 io/IMG = xm0uray-site_5 | chrome api ++v977"
...
def clean_up():
	os.system("rm -rf /tmp/*")
	os.system("rm ipifo.json && rm l05_00  > /dev/null 2>&1")
	os.system("rm -rf  my_mod/__pycache__/ ")
