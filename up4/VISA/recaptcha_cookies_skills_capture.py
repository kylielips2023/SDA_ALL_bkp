...
def cokie_get(browser):
    ...
    # cookies_name=cookies_captured[0]+"_skill_cookies.pkl"
    cookies_name="skill_cookies.pkl"

    pickle.dump(cookies, open(cookies_name, "wb"))
    print("coockies saved !! "+cookies_name)
...
def start_i(browser):
    ...
    # cookies_captured=email_reg
    cookies_captured.append(email_reg)
    print(namee,email_reg)
    print(cookies_captured[0])
    try:
