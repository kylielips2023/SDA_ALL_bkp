...
from anx import zet , kookie ,session_chrom ,api_mysql
...
all_s=["l00k0xmainxvoda","cikox0xmain","danayxmaindanay","cikochildxone","bigoctbig","vanishxmainxtow" \
...
# email = all_s[2]
g_index , email = api_mysql.get_active_goo()
password = "g0ping0*"
